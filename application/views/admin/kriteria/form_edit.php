		...
		<div class="section-body">
			...
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-6">
					<form method="post" action="<?php echo site_url('kriteria/edit');?>">
						<div class="card">
								...
								<div class="card-body">
									<div class="form-group row">
										...
										<div class="col-sm-9 mb-4">
											<input type="text" class="form-control" id="inputEmail3" name="kode_kriteria"
												placeholder="Kode Kriteria" value="<?php echo $kriteria->kode_kriteria;?>">
										</div>
										<label for="inputEmail3" class="col-sm-3 cpl-form-label">Nama Kriteria</label>
										<div class="col-sm-9 mb-4">
											<input type="text" class="form-control" id="inputEmail3" name="nama_kriteria"
												placeholder="Nama Kriteria" value="<?php echo $kriteria->nama_kriteria;?>">
										</div>
										<label for="inputEmail3" class="col-sm-3 cpl-form-label">Bobot</label>
										<div class="col-sm-9 mb-4">
											<input type="text" class="form-control" id="inputEmail3" name="bobot" placeholder="Bobot"
										...
										<div class="col-sm-9 mb-4">
											...
											<select class="form-control" name="jenis" id="jenis" required>
												<option value="Benefit" <?= ($kriteria->jenis == 'Benefit' ? 'selected' : ''); ?>
													class="form-user-input">Benefit</option>
												<option value="Cost" <?= ($kriteria->jenis == 'Cost' ? 'selected' : ''); ?>
													class="form-user-input">Cost
												</option>
